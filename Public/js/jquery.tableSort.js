...
jQuery.fn.sortTable = function(params) {
	...
	params.sortType == 'numeric' ? valuesToSort.sort(function(a, b) { return (parseFloat(a)-parseFloat(b)); }) : valuesToSort.sort();
	if (params.sortDesc) {
	...
	for(var k in valuesToSort) {
		...
		var done = 0;
		animateOn.children('div').animate({top: moveBy_top}, !params.noAnim ? 100 : 0, null, function() {
